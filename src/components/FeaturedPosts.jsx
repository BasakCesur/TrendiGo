    ...
    <section className="py-10 px-5">
      ...
      <div className="grid grid-cols-1 gap-6 mt-8 md:grid-cols-2 lg:grid-cols-3 md:gap-4 lg:gap-6 md:px-10">
        {posts.map((post) => (
          <div
            key={post.id}
            className="rounded-lg overflow-hidden shadow-md hover:shadow-lg transition-shadow w-full max-w-[348px] h-[606px] mx-auto"
          >
            ...
            <div className="p-4">
              ...
              <Link
                to={post.link}
                className="block text-blue-600 font-semibold mt-4 hover:underline"
              >
                Learn More &gt;
              </Link>
            </div>
